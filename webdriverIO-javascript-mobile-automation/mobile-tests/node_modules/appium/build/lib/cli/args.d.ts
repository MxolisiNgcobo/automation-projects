 ...
 */
export const getExtensionArgs: (() => Record<import("../../../types/build").ExtensionType, Record<import("appium/types").CliExtensionSubcommand, ArgumentDefinitions>>) & _.MemoizedFunction;
