import { validMobilePin, invalidMobileLogin } from '../helpers/config'
//import { mobileLoginButton } from '../atoms/bottons'

export async function loginIncorrectUser(t)
{
    ...
    const mobileUser = `${invalidMobileLogin}`
    const mobilePin = `${validMobilePin}`
